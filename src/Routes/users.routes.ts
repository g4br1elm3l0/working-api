...
userRouter.delete('/:userId/services/:servicesId', ensureAuthMiddleware, ensureIsValidIdMiddleware(Users, UserServices), ensureIsAdmMiddleware) // deletar um serviço (apenas administradores/dono)
