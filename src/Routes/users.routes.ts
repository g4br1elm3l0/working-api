...
import { createUserController, listAnUserController, listUsersController, listWorkersController, UpdateUserController } from './../Controllers/users.controllers';
...
userRouter.get('/:id', ensureAuthMiddleware, ensureIsAdmMiddleware, ensureIsValidIdMiddleware(Users), listAnUserController);
