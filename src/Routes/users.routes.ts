...
userRouter.get('/:userId/services', ensureAuthMiddleware, ensureIsAdmMiddleware, ensureIsValidIdMiddleware(Users), listServicesOfUserController) // listar todos os serviços de um usuário (apenas administradores/dono)
