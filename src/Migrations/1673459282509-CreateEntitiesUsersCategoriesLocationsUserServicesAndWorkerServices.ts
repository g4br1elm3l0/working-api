...
export class CreateEntitiesUsersCategoriesLocationsUserServicesAndWorkerServices1673459282509 implements MigrationInterface {
    name = 'CreateEntitiesUsersCategoriesLocationsUserServicesAndWorkerServices1673459282509'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(100) NOT NULL, "password" character varying NOT NULL, "gender" character varying NOT NULL, "birthday" character varying NOT NULL, "profileImg" character varying NOT NULL, "telephone" character varying(11) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "isWorker" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
