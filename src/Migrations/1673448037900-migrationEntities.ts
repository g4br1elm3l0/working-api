...
<<<<<<<< HEAD:src/Migrations/1673398888521-migrationUpdateWorker.ts
export class migrationUpdateWorker1673398888521 implements MigrationInterface {
    name = 'migrationUpdateWorker1673398888521'
...
========
export class migrationEntities1673448037900 implements MigrationInterface {
    name = 'migrationEntities1673448037900'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "addresses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "zipCode" character varying(8) NOT NULL, "district" character varying NOT NULL, "number" integer NOT NULL, "reference" character varying, "city" character varying NOT NULL, "state" character varying(2) NOT NULL, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "workerServices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "acceptedAt" TIMESTAMP, "userId" uuid, "userServiceId" uuid, CONSTRAINT "REL_6827c75118ea603ffb1673737e" UNIQUE ("userServiceId"), CONSTRAINT "PK_2829557eacadbd9526e55f76c1e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(100) NOT NULL, "password" character varying NOT NULL, "gender" character varying NOT NULL, "birthday" TIMESTAMP NOT NULL, "profileImg" character varying NOT NULL, "telephone" character varying(11) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "isWorker" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "addressId" uuid, "locationId" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "REL_49acb911ee20b02f86ec532a12" UNIQUE ("locationId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "locations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "longitude" integer NOT NULL, "latitude" integer NOT NULL, "userId" uuid, "serviceId" uuid, CONSTRAINT "REL_78eda52dc27b7ad20350c4a752" UNIQUE ("userId"), CONSTRAINT "REL_31ccc8588cd6dee4420ebdc6a0" UNIQUE ("serviceId"), CONSTRAINT "PK_7cc1c9e3853b94816c094825e74" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "userServices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(50) NOT NULL, "description" character varying(300) NOT NULL, "femaleOnly" boolean NOT NULL DEFAULT false, "status" character varying NOT NULL DEFAULT 'pendente', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, "categoryId" uuid, "locationId" uuid, CONSTRAINT "REL_1d1cdd24d772647ab23baf6955" UNIQUE ("locationId"), CONSTRAINT "PK_457b50b21c0548222619cc2e3ef" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`DROP TABLE "workerServices"`);
>>>>>>>> d762fde47418e367cbdea225e743a691e39ee3d4:src/Migrations/1673448037900-migrationEntities.ts
